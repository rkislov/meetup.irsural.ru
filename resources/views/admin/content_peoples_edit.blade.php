<div class="wrapper container-fluid">
    {!! Form::open(['url'=>route('peoplesEdit',['people'=>$data['id']]), 'class'=>'form-horizontal','method'=>'POST','enctype'=>'multipart/form-data']) !!}
    ...
    <div class="form-group">
        {!! Form::label('position','Псевдоним:',['class'=>'col-xs-2 control-label']) !!}
        <div class="col-xs-8">
            {!! Form::text('position',$data['position'],['class'=>'form-control', 'placeholder'=>'Введите псевдоним']) !!}
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-8">
            {!! Form::textarea('text',$data['text'],['id'=>'editor','class'=>'form-control', 'placeholder'=>'Текст']) !!}
        </div>
    </div>
    <div class="form-group">
